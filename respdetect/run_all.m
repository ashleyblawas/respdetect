...
load(strcat(data_path, "\gm\gm08_143bbreaths_val.mat"));
...
% Load in validation breathing information
load(strcat(data_path, "\tests\mn\mn17_310abreaths_val.mat"));
...
% Load in breathing information generated by user
load(strcat(data_path, "\tests\breaths\mn17_310abreaths.mat"));
