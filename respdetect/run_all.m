...
load(strcat(data_path, "\gm\breaths\gm08_143bbreaths_val.mat"));
...
load(strcat(data_path, "\gm\breaths\gm08_143bbreaths.mat"));
...
% Load in validation breathing information
load(strcat(data_path, "\mn\breaths\mn17_310abreaths_val.mat"));
...
% Load in breathing information generated by user
load(strcat(data_path, "\mn\breaths\mn17_310abreaths.mat"));
